...
class MapOptions {
 public:
  ...
  bool translucent_texture_surface() const;
  void set_translucent_texture_surface(bool value_arg);

  // The MapView foreground color that is used when the map surface is being created.
  int64_t foreground_load_color() const;
  void set_foreground_load_color(int64_t value_arg);
 ...
 private:
  ...
  bool translucent_texture_surface_;
  int64_t foreground_load_color_;
};
