...
void MapLibreHostApi::SetUp(
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddFillLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddCircleLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto* below_layer_id_arg = std::get_if<std::string>(&encodable_below_layer_id_arg);
          const auto& encodable_above_layer_id_arg = args.at(4);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddBackgroundLayer(id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddFillExtrusionLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddHeatmapLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddHillshadeLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddLineLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddRasterLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
    ...
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          ...
          const auto& encodable_above_layer_id_arg = args.at(5);
          const auto* above_layer_id_arg = std::get_if<std::string>(&encodable_above_layer_id_arg);
          api->AddSymbolLayer(id_arg, source_id_arg, layout_arg, paint_arg, below_layer_id_arg, above_layer_id_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
  ...
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.maplibre.MapLibreHostApi.addImages" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
          const auto& encodable_images_arg = args.at(0);
          if (encodable_images_arg.IsNull()) {
            reply(WrapError("images_arg unexpectedly null."));
            return;
          }
          const auto& images_arg = std::get<EncodableMap>(encodable_images_arg);
          api->AddImages(images_arg, [reply](std::optional<FlutterError>&& output) {
            if (output.has_value()) {
              reply(WrapError(output.value()));
              return;
            }
...
void PermissionManagerHostApi::SetUp(
  ...
  const std::string prepended_suffix = message_channel_suffix.length() > 0 ? std::string(".") + message_channel_suffix : "";
  {
    BasicMessageChannel<> channel(binary_messenger, "dev.flutter.pigeon.maplibre.PermissionManagerHostApi.requestLocationPermissions" + prepended_suffix, &GetCodec());
    if (api != nullptr) {
      channel.SetMessageHandler([api](const EncodableValue& message, const flutter::MessageReply<EncodableValue>& reply) {
        try {
          const auto& args = std::get<EncodableList>(message);
