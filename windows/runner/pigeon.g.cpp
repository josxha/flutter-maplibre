...
MapOptions::MapOptions(
  ...
  bool translucent_texture_surface,
 ...
 : style_(style),
    ...
    translucent_texture_surface_(translucent_texture_surface),
    foreground_load_color_(foreground_load_color) {}
...
MapOptions::MapOptions(const MapOptions& other)
 : style_(other.style_),
    ...
    translucent_texture_surface_(other.translucent_texture_surface_),
    foreground_load_color_(other.foreground_load_color_) {}
...
bool MapOptions::translucent_texture_surface() const {
  return translucent_texture_surface_;
}

void MapOptions::set_translucent_texture_surface(bool value_arg) {
  translucent_texture_surface_ = value_arg;
}


int64_t MapOptions::foreground_load_color() const {
  return foreground_load_color_;
}

void MapOptions::set_foreground_load_color(int64_t value_arg) {
  foreground_load_color_ = value_arg;
}
...
EncodableList MapOptions::ToEncodableList() const {
  ...
  list.push_back(EncodableValue(translucent_texture_surface_));
  list.push_back(EncodableValue(foreground_load_color_));
  return list;
}
