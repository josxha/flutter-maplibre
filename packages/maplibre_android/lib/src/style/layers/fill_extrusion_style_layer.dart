...
class FillExtrusionStyleLayerAndroid
  ...
  @override
  set base(PropertyValue<double> property) => using((arena) {
    final jProperty = property.apply(
      arena: arena,
      onExpression: jni.PropertyFactory.fillExtrusionBase$1,
      onValue: (value) => jni.PropertyFactory.fillExtrusionBase(
  ...
  set color(PropertyValue<Color> property) => using((arena) {
    final jProperty = property.apply(
      ...
      onValue: (value) => jni.PropertyFactory.fillExtrusionColor$1(
  ...
  @override
  set height(PropertyValue<double> property) => using((arena) {
    final jProperty = property.apply(
      arena: arena,
      onExpression: jni.PropertyFactory.fillExtrusionHeight$1,
      onValue: (value) => jni.PropertyFactory.fillExtrusionHeight(
        value.toJFloat()..releasedBy(arena),
      ),
    );
    jProperty?.releasedBy(arena);
  ...
  set opacity(PropertyValue<double> property) => using((arena) {
    final jProperty = property.apply(
      ...
      onValue: (value) => jni.PropertyFactory.fillExtrusionOpacity(
        value.toJFloat()..releasedBy(arena),
      ),
    );
    jProperty?.releasedBy(arena);
  ...
  set pattern(PropertyValue<String>? property) => using((arena) {
    final jProperty = property.apply(
      ...
      onValue: (value) => jni.PropertyFactory.fillExtrusionPattern(
  ...
  set translate(PropertyValue<Offset> property) => using((arena) {
    final jProperty = property.apply(
      ...
      onValue: (value) => jni.PropertyFactory.fillExtrusionTranslate(
  ...
  set translateAnchor(PropertyValue<ReferenceSpace> property) => using((arena) {
    final jProperty = property.apply(
      ...
      onValue: (value) => jni.PropertyFactory.fillExtrusionTranslateAnchor(
  ...
  @override
  set verticalGradient(PropertyValue<bool> property) => using((arena) {
    final jProperty = property.apply(
      arena: arena,
      onExpression: jni.PropertyFactory.fillExtrusionVerticalGradient$1,
      onValue: (value) => jni.PropertyFactory.fillExtrusionVerticalGradient(
