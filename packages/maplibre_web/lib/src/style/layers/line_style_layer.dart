...
class LineStyleLayerWeb extends StyleLayerWeb implements LineStyleLayer {
  ...
  set cap(PropertyValue<LineCap> property) =>
      requireMap.setLayoutProperty(id, 'line-cap', property.toJson().jsify());
  ...
  set join(PropertyValue<LineJoin> property) =>
      requireMap.setLayoutProperty(id, 'line-join', property.toJson().jsify());
  ...
  @override
  set miterLimit(PropertyValue<double> property) => requireMap
      .setLayoutProperty(id, 'line-miter-limit', property.toJson().jsify());
  ...
  @override
  set roundLimit(PropertyValue<double> property) => requireMap
      .setLayoutProperty(id, 'line-round-limit', property.toJson().jsify());

  @override
  PropertyValue<double>? get sortKey => requireMap
      .getLayoutProperty(id, 'line-sort-key')
      .toPropertyValue<double>();
  ...
  PropertyValue<double> get opacity =>
      requireMap
          .getPaintProperty(id, 'line-opacity')
          .toPropertyValue<double>() ??
  ...
  set color(PropertyValue<Color> property) =>
      requireMap.setPaintProperty(id, 'line-color', property.toJson().jsify());
  ...
  set width(PropertyValue<double> property) =>
      requireMap.setPaintProperty(id, 'line-width', property.toJson().jsify());

  @override
  PropertyValue<double> get gapWidth =>
      requireMap
          .getPaintProperty(id, 'line-gap-width')
          .toPropertyValue<double>() ??
  ...
  PropertyValue<double> get offset =>
      requireMap
          .getPaintProperty(id, 'line-offset')
          .toPropertyValue<double>() ??
      LineStyleLayer.defaultOffset;

  @override
  set offset(PropertyValue<double> property) =>
      requireMap.setPaintProperty(id, 'line-offset', property.toJson().jsify());
  ...
  set blur(PropertyValue<double> property) =>
      requireMap.setPaintProperty(id, 'line-blur', property.toJson().jsify());
  ...
  @override
  set gradient(PropertyValue<Color>? property) => requireMap.setPaintProperty(
    id,
    'line-gradient',
    property?.toJson().jsify(),
  );
