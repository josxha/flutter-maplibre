...
class HillshadeStyleLayerWeb extends StyleLayerWeb
  ...
  @override
  set illuminationDirection(PropertyValue<NumberArray> property) => requireMap
      .setPaintProperty(
        id,
  ...
  @override
  set illuminationAltitude(PropertyValue<NumberArray> property) => requireMap
      .setPaintProperty(
        id,
  ...
  @override
  set illuminationAnchor(PropertyValue<IlluminationAnchor> property) => requireMap
      .setPaintProperty(
        id,
  ...
  @override
  set exaggeration(PropertyValue<double> property) => requireMap.setPaintProperty(
        id,
  ...
  @override
  set highlightColor(PropertyValue<Color> property) => requireMap.setPaintProperty(
        id,
  ...
  @override
  set method(PropertyValue<HillshadeMethod> property) => requireMap.setPaintProperty(
        id,
        'hillshade-method',
        property.toJson().jsify(),
      );
