...
Expression<T> match<T extends Object?>({
  ...
  required Map<Object?, Expression<T>> cases,
  required Expression<T> fallback,
}) => Expression.fromJson([
  'match',
  input,
...
Expression<bool> greaterThanOrEqual(OneOf input1, OneOf input2, {String? collator}) =>
    Expression.fromJson([
      '>=',
      input1,
      input2,
...
Expression<bool> lessThanOrEqual(OneOf input1, OneOf input2, {String? collator}) =>
    Expression.fromJson([
      '<=',
      input1,
      input2,
...
Expression<bool> within(OneOf2<Point, LineString> input) => Expression.fromJson([
  'within',
  switch (input) {
