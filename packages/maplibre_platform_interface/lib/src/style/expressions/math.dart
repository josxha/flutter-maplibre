...
Expression<num> subtract(Expression<num> input1, [Expression<num>? input2]) =>
...
Expression<num> divide(Expression<num> dividend, Expression<num> divisor) =>
...
Expression<num> mod_(Expression<num> dividend, Expression<num> divisor) =>
    Expression.fromJson(['mod', dividend, divisor]);

/// Returns the result of raising the first input to the power specified by the second.
/// [base]: number- The base.
/// [exponent]: number- The exponent.
Expression<num> pow_(Expression<num> base, Expression<num> exponent) =>
    Expression.fromJson(['pow', base, exponent]);

/// Returns the square root of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#sqrt
Expression<num> sqrt_(Expression<num> input) =>
    Expression.fromJson(['sqrt', input]);

/// Returns the base 10 logarithm of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#log10
Expression<num> log10_(Expression<num> input) =>
    Expression.fromJson(['log10', input]);

/// Returns the natural logarithm of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#ln
Expression<num> ln_(Expression<num> input) =>
    Expression.fromJson(['ln', input]);

/// Returns the base 2 logarithm of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#log2
Expression<num> log2_(Expression<num> input) =>
    Expression.fromJson(['log2', input]);

/// Returns the sine of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#sin
Expression<num> sin_(Expression<num> angle) =>
    Expression.fromJson(['sin', angle]);

/// Returns the cosine of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#cos
Expression<num> cos_(Expression<num> angle) =>
    Expression.fromJson(['cos', angle]);

/// Returns the tangent of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#tan
Expression<num> tan_(Expression<num> angle) =>
    Expression.fromJson(['tan', angle]);

/// Returns the arcsine of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#asin
Expression<num> asin_(Expression<num> input) =>
    Expression.fromJson(['asin', input]);

/// Returns the arccosine of the [input].
///
/// https://maplibre.org/maplibre-style-spec/expressions/#acos
Expression<num> acos_(Expression<num> input) =>
    Expression.fromJson(['acos', input]);

/// Returns the arctangent of the [input].
///
/// https://maplibre.org/maplibre-style-spec/expressions/#atan
Expression<num> atan_(Expression<num> input) =>
    Expression.fromJson(['atan', input]);
...
Expression<num> round(Expression<num> input) =>
    Expression.fromJson(['round', input]);

/// Returns the absolute value of the input.
///
/// https://maplibre.org/maplibre-style-spec/expressions/#abs
Expression<num> abs(Expression<num> input) =>
    Expression.fromJson(['abs', input]);

/// Returns the smallest integer that is greater than or equal to the [input].
///
/// https://maplibre.org/maplibre-style-spec/expressions/#ceil
Expression<num> ceil(Expression<num> input) =>
    Expression.fromJson(['ceil', input]);

/// Returns the largest integer that is less than or equal to the [input].
///
/// https://maplibre.org/maplibre-style-spec/expressions/#floor
Expression<num> floor(Expression<num> input) =>
    Expression.fromJson(['floor', input]);
