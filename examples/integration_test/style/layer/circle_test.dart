  ...
  group('Circle Style Layer', () {
    ...
    testWidgets('custom values', (tester) async {
      ...
      _testLayer(
        ...
        translateAnchor: const PropertyValue.value(ReferenceSpace.viewport),
        sortKey: const PropertyValue.value(3.5),
        radius: const PropertyValue.value(6.5),
        blur: const PropertyValue.value(0.5),
        pitchScale: const PropertyValue.value(ReferenceSpace.viewport),
        pitchAlignment: const PropertyValue.value(ReferenceSpace.map),
      ...
      _testLayer(
        ...
        translateAnchor: PropertyValue.expression(
          Expression.interpolate(
            ...
            input: Expression.zoom(),
            stopInputs: const [0, 10],
            stopOutputs: const [ReferenceSpace.map, ReferenceSpace.viewport],
          ),
        ),
