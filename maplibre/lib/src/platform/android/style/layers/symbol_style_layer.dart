...
class SymbolStyleLayerAndroid extends StyleLayerAndroid<jni.SymbolLayer>
	...
	factory SymbolStyleLayerAndroid({
		...
		PropertyValue<bool> textAllowOverlap = SymbolStyleLayer.defaultTextAllowOverlap,
	...
	SymbolStyleLayerAndroid.fromNativeLayer(super.jLayer) : super.fromNativeLayer();

	PropertyValue<SymbolOverlap> _iconOverlap = SymbolStyleLayer.defaultIconOverlap;
	...
	@override
	String get sourceId => jLayer.getSourceId().toDartString(releaseOriginal: true);
	...
	@override
	PropertyValue<IconRotationAlignment> get iconRotationAlignment => _enumProperty(
	...
	@override
	PropertyValue<TextRotationAlignment> get textRotationAlignment => _enumProperty(
	...
	PropertyValue<String> get textField => using((arena) {
		...
		if (jProperty.isExpression()) {
			final jExpression = jProperty.getExpression()?..releasedBy(arena);
			final expression = jExpression?.toDart(releaseOriginal: true);
			return expression == null ? _textField : PropertyValue.expression(expression);
		}
