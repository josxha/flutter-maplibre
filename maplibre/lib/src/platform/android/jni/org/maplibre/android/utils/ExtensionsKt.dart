...
/// from: `public fun isNaN(d: kotlin.Double): kotlin.Boolean`
bool isNaN(
...
/// from: `public fun isNaN(f: kotlin.Float): kotlin.Boolean`
bool isNaN$1(
...
/// from: `public fun isInfinite(d: kotlin.Double): kotlin.Boolean`
bool isInfinite(
  jni$_.JObject doubleCompanionObject,
  double d,
) {
...
/// from: `public fun isInfinite(f: kotlin.Double): kotlin.Boolean`
bool isInfinite$1(
  jni$_.JObject floatCompanionObject,
  double d,
) {
