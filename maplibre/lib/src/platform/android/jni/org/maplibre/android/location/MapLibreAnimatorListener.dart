...
class MapLibreAnimatorListener extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<MapLibreAnimatorListener> $type;
  ...
  static const jni$_.JType<MapLibreAnimatorListener?> nullableType =
      $MapLibreAnimatorListener$NullableType$();

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<MapLibreAnimatorListener> type =
      $MapLibreAnimatorListener$Type$();
  ...
  /// from: `public fun onAnimationCancel(animation: android.animation.Animator): kotlin.Unit`
  ...
  /// from: `public fun onAnimationEnd(animation: android.animation.Animator): kotlin.Unit`
  void onAnimationEnd(
    jni$_.JObject animator,
  ) {
    final _$animator = animator.reference;
...
final class $MapLibreAnimatorListener$NullableType$
    extends jni$_.JType<MapLibreAnimatorListener?> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<MapLibreAnimatorListener?> get nullableType => this;
...
final class $MapLibreAnimatorListener$Type$
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<MapLibreAnimatorListener?> get nullableType =>
      const $MapLibreAnimatorListener$NullableType$();
