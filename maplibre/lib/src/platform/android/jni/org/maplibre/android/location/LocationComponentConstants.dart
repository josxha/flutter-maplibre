...
class LocationComponentConstants extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<LocationComponentConstants> $type;
  ...
  static const jni$_.JType<LocationComponentConstants?> nullableType =
      $LocationComponentConstants$NullableType$();

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<LocationComponentConstants> type =
      $LocationComponentConstants$Type$();
  ...
  static jni$_.JString? get LOCATION_SOURCE =>
      _id_LOCATION_SOURCE.get(_class, const jni$_.$JString$NullableType$());
  ...
  static jni$_.JString? get SHADOW_LAYER =>
      _id_SHADOW_LAYER.get(_class, const jni$_.$JString$NullableType$());
  ...
  static jni$_.JString? get FOREGROUND_LAYER =>
      _id_FOREGROUND_LAYER.get(_class, const jni$_.$JString$NullableType$());
  ...
  static jni$_.JString? get BACKGROUND_LAYER =>
      _id_BACKGROUND_LAYER.get(_class, const jni$_.$JString$NullableType$());
  ...
  static jni$_.JString? get ACCURACY_LAYER =>
      _id_ACCURACY_LAYER.get(_class, const jni$_.$JString$NullableType$());
  ...
  static jni$_.JString? get BEARING_LAYER =>
      _id_BEARING_LAYER.get(_class, const jni$_.$JString$NullableType$());
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static jni$_.JString? get PULSING_CIRCLE_LAYER => _id_PULSING_CIRCLE_LAYER
      .get(_class, const jni$_.$JString$NullableType$());
}

final class $LocationComponentConstants$NullableType$
    extends jni$_.JType<LocationComponentConstants?> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<LocationComponentConstants?> get nullableType => this;
...
final class $LocationComponentConstants$Type$
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<LocationComponentConstants?> get nullableType =>
      const $LocationComponentConstants$NullableType$();
