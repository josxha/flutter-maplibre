...
class HttpResponder extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<HttpResponder> $type;
  ...
  static const jni$_.JType<HttpResponder?> nullableType =
      $HttpResponder$NullableType$();

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<HttpResponder> type = $HttpResponder$Type$();
    ...
    try {
      ...
      if ($d ==
        ...
        _$impls[$p]!.onResponse(
          ...
          $a![4]?.as(const jni$_.$JString$Type$(), releaseOriginal: true),
          $a![5]?.as(const jni$_.$JString$Type$(), releaseOriginal: true),
          $a![6]?.as(const jni$_.$JString$Type$(), releaseOriginal: true),
          $a![7]?.as(const jni$_.$JByteArray$Type$(), releaseOriginal: true),
        );
...
final class $HttpResponder$NullableType$ extends jni$_.JType<HttpResponder?> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<HttpResponder?> get nullableType => this;
...
final class $HttpResponder$Type$ extends jni$_.JType<HttpResponder> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<HttpResponder?> get nullableType =>
      const $HttpResponder$NullableType$();
