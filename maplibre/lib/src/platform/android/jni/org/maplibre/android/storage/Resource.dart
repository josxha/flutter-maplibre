...
class Resource$Kind extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<Resource$Kind> $type;
  ...
  static const jni$_.JType<Resource$Kind?> nullableType =
      $Resource$Kind$NullableType$();

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<Resource$Kind> type = $Resource$Kind$Type$();
...
final class $Resource$Kind$NullableType$ extends jni$_.JType<Resource$Kind?> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<Resource$Kind?> get nullableType => this;
...
final class $Resource$Kind$Type$ extends jni$_.JType<Resource$Kind> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<Resource$Kind?> get nullableType =>
      const $Resource$Kind$NullableType$();
...
class Resource extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<Resource> $type;
  ...
  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<Resource?> nullableType = $Resource$NullableType$();

  /// The type which includes information such as the signature of this class.
  static const jni$_.JType<Resource> type = $Resource$Type$();
...
final class $Resource$NullableType$ extends jni$_.JType<Resource?> {
  @jni$_.internal
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<Resource?> get nullableType => this;
...
final class $Resource$Type$ extends jni$_.JType<Resource> {
  @jni$_.internal
  const $Resource$Type$();
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<Resource?> get nullableType => const $Resource$NullableType$();
