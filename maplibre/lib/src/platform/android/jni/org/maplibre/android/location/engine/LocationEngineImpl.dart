...
class LocationEngineImpl<$T extends jni$_.JObject?> extends jni$_.JObject {
  @jni$_.internal
  @core$_.override
  final jni$_.JType<LocationEngineImpl<$T>> $type;
  ...
  static jni$_.JType<LocationEngineImpl<$T>?>
  ...
  /// The type which includes information such as the signature of this class.
  static jni$_.JType<LocationEngineImpl<$T>> type<$T extends jni$_.JObject?>(
    jni$_.JType<$T> T,
  ) {
  ...
  /// from: `public abstract T createListener(org.maplibre.android.location.engine.LocationEngineCallback<org.maplibre.android.location.engine.LocationEngineResult> locationEngineCallback)`
...
final class $LocationEngineImpl$NullableType$<$T extends jni$_.JObject?>
    extends jni$_.JType<LocationEngineImpl<$T>?> {
  @jni$_.internal
  final jni$_.JType<$T> T;
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<LocationEngineImpl<$T>?> get nullableType => this;
...
final class $LocationEngineImpl$Type$<$T extends jni$_.JObject?>
  ...
  @jni$_.internal
  @core$_.override
  jni$_.JType<LocationEngineImpl<$T>?> get nullableType =>
