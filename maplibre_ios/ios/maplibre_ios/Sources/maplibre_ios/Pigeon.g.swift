...
private func createConnectionError(withChannelName channelName: String)
    -> PigeonError
{
    return PigeonError(
        code: "channel-error",
...
class PigeonPigeonCodec: FlutterStandardMessageCodec, @unchecked Sendable {
    static let shared = PigeonPigeonCodec(
        readerWriter: PigeonPigeonCodecReaderWriter())
}
...
protocol MapLibreHostApi {
    ...
    func addBackgroundLayer(
        id: String, layout: [String: Any], paint: [String: Any],
        belowLayerId: String?,
        completion: @escaping (Result<Void, Error>) -> Void)
...
class MapLibreHostApiSetup {
    ...
    static func setUp(
        ...
        let channelSuffix =
            messageChannelSuffix.count > 0 ? ".\(messageChannelSuffix)" : ""
        let disposeChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.dispose\(channelSuffix)",
        ...
        let addFillLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addFillLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            addFillLayerChannel.setMessageHandler { message, reply in
                ...
                api.addFillLayer(
                    id: idArg, sourceId: sourceIdArg, layout: layoutArg,
                    paint: paintArg, belowLayerId: belowLayerIdArg
                ) { result in
                    switch result {
                    case .success:
                        reply(wrapResult(nil))
        ...
        let addCircleLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addCircleLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addBackgroundLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addBackgroundLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            addBackgroundLayerChannel.setMessageHandler { message, reply in
                ...
                api.addBackgroundLayer(
                    id: idArg, layout: layoutArg, paint: paintArg,
        ...
        let addFillExtrusionLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addFillExtrusionLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addHeatmapLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addHeatmapLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addHillshadeLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addHillshadeLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addLineLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addLineLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addRasterLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addRasterLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addSymbolLayerChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addSymbolLayer\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let loadImageChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.loadImage\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let addImageChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.MapLibreHostApi.addImage\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
...
protocol MapLibreFlutterApiProtocol {
    ...
    func getOptions(
        completion: @escaping (Result<MapOptions, PigeonError>) -> Void)
    ...
    func getOptions(
        ...
        channel.sendMessage(nil) { response in
            guard let listResponse = response as? [Any?] else {
                completion(
                    .failure(
                        createConnectionError(withChannelName: channelName)))
                return
            }
...
class PermissionManagerHostApiSetup {
    ...
    static func setUp(
        ...
        let requestLocationPermissionsChannel = FlutterBasicMessageChannel(
            ...
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            requestLocationPermissionsChannel.setMessageHandler {
                message, reply in
                let args = message as! [Any?]
                let explanationArg = args[0] as! String
                api.requestLocationPermissions(explanation: explanationArg) {
                    result in
                    switch result {
                    case .success(let res):
                        reply(wrapResult(res))
...
protocol OfflineManagerHostApi {
    ...
    func setMaximumAmbientCacheSize(
        bytes: Int64, completion: @escaping (Result<Void, Error>) -> Void)
...
class OfflineManagerHostApiSetup {
    ...
    static func setUp(
        ...
        let clearAmbientCacheChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.OfflineManagerHostApi.clearAmbientCache\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let resetDatabaseChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.OfflineManagerHostApi.resetDatabase\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
        ...
        let setMaximumAmbientCacheSizeChannel = FlutterBasicMessageChannel(
            ...
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            setMaximumAmbientCacheSizeChannel.setMessageHandler {
                message, reply in
                let args = message as! [Any?]
        ...
        let downloadRegionChannel = FlutterBasicMessageChannel(
            name:
                "dev.flutter.pigeon.maplibre.OfflineManagerHostApi.downloadRegion\(channelSuffix)",
            binaryMessenger: binaryMessenger, codec: codec)
        if let api = api {
            downloadRegionChannel.setMessageHandler { message, reply in
                ...
                api.downloadRegion(
                    mapStyleUrl: mapStyleUrlArg, bounds: boundsArg,
                    minZoom: minZoomArg, maxZoom: maxZoomArg,
