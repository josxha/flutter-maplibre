...
@immutable
class MapLibreInFlutterMapPage extends StatefulWidget {
  const MapLibreInFlutterMapPage({super.key});

  static const location = '/maplibre-in-flutter-map';

  @override
  State<MapLibreInFlutterMapPage> createState() => _MapLibreInFlutterMapPageState();
}

typedef HitValue = ({String title, String subtitle});

class _MapLibreInFlutterMapPageState extends State<MapLibreInFlutterMapPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('MapLibre in FlutterMap')),
      body: FlutterMap(
