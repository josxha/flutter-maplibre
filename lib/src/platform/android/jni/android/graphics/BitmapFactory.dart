...
class BitmapFactory$Options extends jni$_.JObject {
  ...
  jni$_.JObject? get inBitmap =>
      _id_inBitmap.get(this, const jni$_.JObjectNullableType());

  /// from: `public android.graphics.Bitmap inBitmap`
  /// The returned object must be released after use, by calling the [release] method.
  set inBitmap(jni$_.JObject? value) =>
      _id_inBitmap.set(this, const jni$_.JObjectNullableType(), value);
  ...
  jni$_.JObject? get inPreferredConfig =>
      _id_inPreferredConfig.get(this, const jni$_.JObjectNullableType());

  /// from: `public android.graphics.Bitmap$Config inPreferredConfig`
  /// The returned object must be released after use, by calling the [release] method.
  set inPreferredConfig(jni$_.JObject? value) =>
      _id_inPreferredConfig.set(this, const jni$_.JObjectNullableType(), value);
  ...
  jni$_.JObject? get outConfig =>
      _id_outConfig.get(this, const jni$_.JObjectNullableType());

  /// from: `public android.graphics.Bitmap$Config outConfig`
  /// The returned object must be released after use, by calling the [release] method.
  set outConfig(jni$_.JObject? value) =>
      _id_outConfig.set(this, const jni$_.JObjectNullableType(), value);
