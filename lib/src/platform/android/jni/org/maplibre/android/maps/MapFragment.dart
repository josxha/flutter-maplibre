...
class MapFragment$OnMapViewReadyCallback extends jni$_.JObject {
  ...
  static final _onMapViewReady = jni$_.ProtectedJniExtensions.lookup<
  ...
  void onMapViewReady(
    ...
    _onMapViewReady(reference.pointer, _id_onMapViewReady as jni$_.JMethodIDPtr,
            _$mapView.pointer)
        .check();
  }
...
class MapFragment extends jni$_.JObject {
  ...
  static final _class =
      jni$_.JClass.forName(r'org/maplibre/android/maps/MapFragment');
