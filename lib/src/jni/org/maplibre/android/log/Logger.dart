...
class Logger_LogLevel extends jni.JObject {
  ...
  static final Map<int, $Logger_LogLevelImpl> _$impls = {};
  ReceivePort? _$p;
  ...
  factory Logger_LogLevel.implement(
    $Logger_LogLevelImpl $impl,
  ) {
    final $p = ReceivePort();
    final $x = Logger_LogLevel.fromReference(
...
abstract interface class $Logger_LogLevelImpl {
  factory $Logger_LogLevelImpl() = _$Logger_LogLevelImpl;
}

class _$Logger_LogLevelImpl implements $Logger_LogLevelImpl {
  _$Logger_LogLevelImpl();
}
