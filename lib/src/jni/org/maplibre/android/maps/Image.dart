...
class Image extends jni.JObject {
  ...
  static final _class = jni.JClass.forName(r'org/maplibre/android/maps/Image');
  ...
  factory Image(
    ...
    return Image.fromReference(_new0(
  ...
  factory Image.new1(
    ...
    jni.JArray<jni.jfloat> fs1,
    jni.JArray<jni.jfloat> fs2,
  ) {
    return Image.fromReference(_new1(
            _class.reference.pointer,
