...
class SupportMapFragment extends jni.JObject {
  @override
  late final jni.JObjType<SupportMapFragment> $type = type;
  ...
  static final _class =
      jni.JClass.forName(r'org/maplibre/android/maps/SupportMapFragment');

  /// The type which includes information such as the signature of this class.
  static const type = $SupportMapFragmentType();
  ...
  static SupportMapFragment newInstance() {
    return _newInstance(
        ...
        .object(const $SupportMapFragmentType());
  }
  ...
  /// The returned object must be released after use, by calling the [release] method.
  static SupportMapFragment newInstance1(
...
final class $SupportMapFragmentType extends jni.JObjType<SupportMapFragment> {
  const $SupportMapFragmentType();

  @override
  String get signature => r'Lorg/maplibre/android/maps/SupportMapFragment;';

  @override
  SupportMapFragment fromReference(jni.JReference reference) =>
  ...
  @override
  int get hashCode => ($SupportMapFragmentType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($SupportMapFragmentType) &&
        other is $SupportMapFragmentType;
  }
}
