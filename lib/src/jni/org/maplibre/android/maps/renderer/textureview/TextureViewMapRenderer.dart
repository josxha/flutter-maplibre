...
class TextureViewMapRenderer extends maprenderer_.MapRenderer {
  @override
  late final jni.JObjType<TextureViewMapRenderer> $type = type;
  ...
  static const type = $TextureViewMapRendererType();
  ...
  factory TextureViewMapRenderer.new1(
    jni.JObject context,
    jni.JObject textureView,
    jni.JString string,
    bool z,
  ) {
    return TextureViewMapRenderer.fromReference(_new1(
  ...
  static final _setRenderThread = ProtectedJniExtensions.lookup<
              ffi.NativeFunction<
  ...
  void setRenderThread(
    jni.JObject textureViewRenderThread,
  ) {
    _setRenderThread(reference.pointer, _id_setRenderThread as jni.JMethodIDPtr,
  ...
  static final _isTranslucentSurface = ProtectedJniExtensions.lookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                ffi.Pointer<ffi.Void>,
                jni.JMethodIDPtr,
  ...
  bool isTranslucentSurface() {
    return _isTranslucentSurface(
            reference.pointer, _id_isTranslucentSurface as jni.JMethodIDPtr)
        .boolean;
  }
...
final class $TextureViewMapRendererType
    extends jni.JObjType<TextureViewMapRenderer> {
  const $TextureViewMapRendererType();
  ...
  @override
  TextureViewMapRenderer fromReference(jni.JReference reference) =>
  ...
  @override
  int get hashCode => ($TextureViewMapRendererType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($TextureViewMapRendererType) &&
        other is $TextureViewMapRendererType;
  }
}
