...
class EGLConfigChooser extends jni.JObject {
  @override
  late final jni.JObjType<EGLConfigChooser> $type = type;
  ...
  static const type = $EGLConfigChooserType();
  ...
  /// The returned object must be released after use, by calling the [release] method.
  factory EGLConfigChooser.new1(
    bool z,
  ) {
    return EGLConfigChooser.fromReference(
        _new1(_class.reference.pointer, _id_new1 as jni.JMethodIDPtr, z ? 1 : 0)
            .reference);
  }
  ...
  static final _chooseConfig = ProtectedJniExtensions.lookup<
          ffi.NativeFunction<
              jni.JniResult Function(
                  ffi.Pointer<ffi.Void>,
                  jni.JMethodIDPtr,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  jni.JObject chooseConfig(
    jni.JObject eGL10,
    jni.JObject eGLDisplay,
  ) {
    return _chooseConfig(
            reference.pointer,
            _id_chooseConfig as jni.JMethodIDPtr,
...
final class $EGLConfigChooserType extends jni.JObjType<EGLConfigChooser> {
  const $EGLConfigChooserType();
  ...
  @override
  EGLConfigChooser fromReference(jni.JReference reference) =>
  ...
  @override
  int get hashCode => ($EGLConfigChooserType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($EGLConfigChooserType) &&
        other is $EGLConfigChooserType;
  }
}
