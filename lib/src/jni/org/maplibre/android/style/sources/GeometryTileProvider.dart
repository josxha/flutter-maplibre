...
class GeometryTileProvider extends jni.JObject {
  @override
  late final jni.JObjType<GeometryTileProvider> $type = type;
  ...
  static const type = $GeometryTileProviderType();
  ...
  static final _getFeaturesForBounds = ProtectedJniExtensions.lookup<
              ffi.NativeFunction<
  ...
  jni.JObject getFeaturesForBounds(
    ...
    return _getFeaturesForBounds(
            reference.pointer,
            _id_getFeaturesForBounds as jni.JMethodIDPtr,
...
final class $GeometryTileProviderType
    extends jni.JObjType<GeometryTileProvider> {
  const $GeometryTileProviderType();
  ...
  @override
  GeometryTileProvider fromReference(jni.JReference reference) =>
  ...
  @override
  int get hashCode => ($GeometryTileProviderType).hashCode;

  @override
  bool operator ==(Object other) {
    return other.runtimeType == ($GeometryTileProviderType) &&
        other is $GeometryTileProviderType;
  }
}
