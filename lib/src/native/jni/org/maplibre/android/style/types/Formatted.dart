...
class Formatted extends _$jni.JObject {
  @_$jni.internal
  @_$core.override
  final _$jni.JObjType<Formatted> $type;
  ...
  static final _class =
      _$jni.JClass.forName(r'org/maplibre/android/style/types/Formatted');

  /// The type which includes information such as the signature of this class.
  static const type = $Formatted$Type();
  ...
  factory Formatted(
    _$jni.JArray<formattedsection_.FormattedSection> formattedSections,
  ) {
    return Formatted.fromReference(_new$(_class.reference.pointer,
            _id_new$ as _$jni.JMethodIDPtr, formattedSections.reference.pointer)
        .reference);
  }
  ...
  static final _getFormattedSections = _$jni.ProtectedJniExtensions.lookup<
          _$jni.NativeFunction<
              _$jni.JniResult Function(
                _$jni.Pointer<_$jni.Void>,
                _$jni.JMethodIDPtr,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  _$jni.JArray<formattedsection_.FormattedSection> getFormattedSections() {
    return _getFormattedSections(
            reference.pointer, _id_getFormattedSections as _$jni.JMethodIDPtr)
        .object(
            const _$jni.JArrayType(formattedsection_.$FormattedSection$Type()));
  }
  ...
  static final _toArray = _$jni.ProtectedJniExtensions.lookup<
          _$jni.NativeFunction<
              _$jni.JniResult Function(
                _$jni.Pointer<_$jni.Void>,
                _$jni.JMethodIDPtr,
  ...
  /// The returned object must be released after use, by calling the [release] method.
  _$jni.JArray<_$jni.JObject> toArray() {
    return _toArray(reference.pointer, _id_toArray as _$jni.JMethodIDPtr)
...
final class $Formatted$Type extends _$jni.JObjType<Formatted> {
  @_$jni.internal
  ...
  @_$jni.internal
  @_$core.override
  Formatted fromReference(_$jni.JReference reference) =>
