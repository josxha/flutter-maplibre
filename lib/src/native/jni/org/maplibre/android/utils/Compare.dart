...
class Compare extends _$jni.JObject {
  @_$jni.internal
  @_$core.override
  final _$jni.JObjType<Compare> $type;
  ...
  static final _class =
      _$jni.JClass.forName(r'org/maplibre/android/utils/Compare');
  ...
  static int compare(
    ...
    return _compare(
            _class.reference.pointer, _id_compare as _$jni.JMethodIDPtr, i, i1)
        .integer;
  }
  ...
  static int compare$1(
    ...
    return _compare$1(_class.reference.pointer,
            _id_compare$1 as _$jni.JMethodIDPtr, z ? 1 : 0, z1 ? 1 : 0)
        .integer;
  }
}

final class $Compare$Type extends _$jni.JObjType<Compare> {
  @_$jni.internal
  const $Compare$Type();
  ...
  @_$jni.internal
  @_$core.override
  Compare fromReference(_$jni.JReference reference) =>
