 ...
 */
extern const int maplibre_tile_scheme_type_id;
extern const int maplibre_raster_dem_encoding_type_id;
extern const int maplibre_camera_change_reason_type_id;
extern const int maplibre_map_options_type_id;
extern const int maplibre_map_gestures_type_id;
extern const int maplibre_lng_lat_type_id;
extern const int maplibre_offset_type_id;
extern const int maplibre_padding_type_id;
extern const int maplibre_map_camera_type_id;
extern const int maplibre_lng_lat_bounds_type_id;
 ...
 */
typedef struct {
  void (*add_fill_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_circle_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_background_layer)(const gchar* id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_fill_extrusion_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_heatmap_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_hillshade_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_line_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_raster_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  void (*add_symbol_layer)(const gchar* id, const gchar* source_id, FlValue* layout, FlValue* paint, const gchar* below_layer_id, const gchar* above_layer_id, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
  ...
  void (*add_images)(FlValue* images, MaplibreMapLibreHostApiResponseHandle* response_handle, gpointer user_data);
} MaplibreMapLibreHostApiVTable;
...
/**
 * maplibre_map_libre_host_api_respond_add_images:
 * @response_handle: a #MaplibreMapLibreHostApiResponseHandle.
 *
...
/**
 * maplibre_map_libre_host_api_respond_error_add_images:
 * @response_handle: a #MaplibreMapLibreHostApiResponseHandle.
 * @code: error code.
 * @message: error message.
 * @details: (allow-none): error details or %NULL.
