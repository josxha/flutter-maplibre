 ...
 * translucent_texture_surface: field in this object.
 * foreground_load_color: field in this object.
 *
...
/**
 * maplibre_map_options_get_translucent_texture_surface
 * @object: a #MaplibreMapOptions.
 *
 ...
 * Returns: the field value.
 */
gboolean maplibre_map_options_get_translucent_texture_surface(MaplibreMapOptions* object);

/**
 * maplibre_map_options_get_foreground_load_color
 * @object: a #MaplibreMapOptions.
 *
 ...
 * Returns: the field value.
 */
int64_t maplibre_map_options_get_foreground_load_color(MaplibreMapOptions* object);
