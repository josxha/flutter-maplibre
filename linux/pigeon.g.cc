...
static MaplibreMapOptions* maplibre_map_options_new_from_list(FlValue* values) {
  ...
  return maplibre_map_options_new(style, zoom, pitch, bearing, center, max_bounds, min_zoom, max_zoom, min_pitch, max_pitch, listens_on_click, listens_on_long_click);
}
