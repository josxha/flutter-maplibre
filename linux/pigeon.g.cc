...
static FlValue* maplibre_map_options_to_list(MaplibreMapOptions* self) {
  ...
  fl_value_append_take(values, self->center != nullptr ? fl_value_new_custom_object(maplibre_lng_lat_type_id, G_OBJECT(self->center)) : fl_value_new_null());
  fl_value_append_take(values, self->max_bounds != nullptr ? fl_value_new_custom_object(maplibre_lng_lat_bounds_type_id, G_OBJECT(self->max_bounds)) : fl_value_new_null());
  ...
  fl_value_append_take(values, fl_value_new_custom_object(maplibre_map_gestures_type_id, G_OBJECT(self->gestures)));
...
static FlValue* maplibre_map_camera_to_list(MaplibreMapCamera* self) {
  FlValue* values = fl_value_new_list();
  fl_value_append_take(values, fl_value_new_custom_object(maplibre_lng_lat_type_id, G_OBJECT(self->center)));
  fl_value_append_take(values, fl_value_new_float(self->zoom));
  fl_value_append_take(values, fl_value_new_float(self->pitch));
  fl_value_append_take(values, fl_value_new_float(self->bearing));
  return values;
...
const int maplibre_tile_scheme_type_id = 129;
const int maplibre_raster_dem_encoding_type_id = 130;
const int maplibre_camera_change_reason_type_id = 131;
const int maplibre_map_options_type_id = 132;
const int maplibre_map_gestures_type_id = 133;
const int maplibre_lng_lat_type_id = 134;
const int maplibre_offset_type_id = 135;
const int maplibre_padding_type_id = 136;
const int maplibre_map_camera_type_id = 137;
const int maplibre_lng_lat_bounds_type_id = 138;
...
static gboolean maplibre_message_codec_write_maplibre_tile_scheme(FlStandardMessageCodec* codec, GByteArray* buffer, FlValue* value, GError** error) {
  uint8_t type = maplibre_tile_scheme_type_id;
...
static gboolean maplibre_message_codec_write_maplibre_raster_dem_encoding(FlStandardMessageCodec* codec, GByteArray* buffer, FlValue* value, GError** error) {
  uint8_t type = maplibre_raster_dem_encoding_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
  return fl_standard_message_codec_write_value(codec, buffer, value, error);
}
...
static gboolean maplibre_message_codec_write_maplibre_camera_change_reason(FlStandardMessageCodec* codec, GByteArray* buffer, FlValue* value, GError** error) {
  uint8_t type = maplibre_camera_change_reason_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
  return fl_standard_message_codec_write_value(codec, buffer, value, error);
}
...
static gboolean maplibre_message_codec_write_maplibre_map_options(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreMapOptions* value, GError** error) {
  uint8_t type = maplibre_map_options_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_map_gestures(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreMapGestures* value, GError** error) {
  uint8_t type = maplibre_map_gestures_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_lng_lat(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreLngLat* value, GError** error) {
  uint8_t type = maplibre_lng_lat_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_offset(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreOffset* value, GError** error) {
  uint8_t type = maplibre_offset_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_padding(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibrePadding* value, GError** error) {
  uint8_t type = maplibre_padding_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_map_camera(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreMapCamera* value, GError** error) {
  uint8_t type = maplibre_map_camera_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_maplibre_lng_lat_bounds(FlStandardMessageCodec* codec, GByteArray* buffer, MaplibreLngLatBounds* value, GError** error) {
  uint8_t type = maplibre_lng_lat_bounds_type_id;
  g_byte_array_append(buffer, &type, sizeof(uint8_t));
...
static gboolean maplibre_message_codec_write_value(FlStandardMessageCodec* codec, GByteArray* buffer, FlValue* value, GError** error) {
  if (fl_value_get_type(value) == FL_VALUE_TYPE_CUSTOM) {
    switch (fl_value_get_custom_type(value)) {
      case maplibre_tile_scheme_type_id:
      ...
      case maplibre_raster_dem_encoding_type_id:
      ...
      case maplibre_camera_change_reason_type_id:
      ...
      case maplibre_map_options_type_id:
      ...
      case maplibre_map_gestures_type_id:
      ...
      case maplibre_map_camera_type_id:
      ...
      case maplibre_lng_lat_bounds_type_id:
...
static FlValue* maplibre_message_codec_read_maplibre_tile_scheme(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  return fl_value_new_custom(maplibre_tile_scheme_type_id, fl_standard_message_codec_read_value(codec, buffer, offset, error), (GDestroyNotify)fl_value_unref);
}
...
static FlValue* maplibre_message_codec_read_maplibre_raster_dem_encoding(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  return fl_value_new_custom(maplibre_raster_dem_encoding_type_id, fl_standard_message_codec_read_value(codec, buffer, offset, error), (GDestroyNotify)fl_value_unref);
}
...
static FlValue* maplibre_message_codec_read_maplibre_camera_change_reason(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  return fl_value_new_custom(maplibre_camera_change_reason_type_id, fl_standard_message_codec_read_value(codec, buffer, offset, error), (GDestroyNotify)fl_value_unref);
}
...
static FlValue* maplibre_message_codec_read_maplibre_map_options(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_map_options_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_map_gestures(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_map_gestures_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_lng_lat(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_lng_lat_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_offset(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_offset_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_padding(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_padding_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_map_camera(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_map_camera_type_id, G_OBJECT(value));
}
...
static FlValue* maplibre_message_codec_read_maplibre_lng_lat_bounds(FlStandardMessageCodec* codec, GBytes* buffer, size_t* offset, GError** error) {
  ...
  return fl_value_new_custom_object(maplibre_lng_lat_bounds_type_id, G_OBJECT(value));
}
...
G_DECLARE_FINAL_TYPE(MaplibreMapLibreHostApiAddImagesResponse, maplibre_map_libre_host_api_add_images_response, MAPLIBRE, MAP_LIBRE_HOST_API_ADD_IMAGES_RESPONSE, GObject)

struct _MaplibreMapLibreHostApiAddImagesResponse {
  GObject parent_instance;

  FlValue* value;
};

G_DEFINE_TYPE(MaplibreMapLibreHostApiAddImagesResponse, maplibre_map_libre_host_api_add_images_response, G_TYPE_OBJECT)

static void maplibre_map_libre_host_api_add_images_response_dispose(GObject* object) {
  MaplibreMapLibreHostApiAddImagesResponse* self = MAPLIBRE_MAP_LIBRE_HOST_API_ADD_IMAGES_RESPONSE(object);
  g_clear_pointer(&self->value, fl_value_unref);
  G_OBJECT_CLASS(maplibre_map_libre_host_api_add_images_response_parent_class)->dispose(object);
}

static void maplibre_map_libre_host_api_add_images_response_init(MaplibreMapLibreHostApiAddImagesResponse* self) {
}

static void maplibre_map_libre_host_api_add_images_response_class_init(MaplibreMapLibreHostApiAddImagesResponseClass* klass) {
  G_OBJECT_CLASS(klass)->dispose = maplibre_map_libre_host_api_add_images_response_dispose;
}

static MaplibreMapLibreHostApiAddImagesResponse* maplibre_map_libre_host_api_add_images_response_new() {
  MaplibreMapLibreHostApiAddImagesResponse* self = MAPLIBRE_MAP_LIBRE_HOST_API_ADD_IMAGES_RESPONSE(g_object_new(maplibre_map_libre_host_api_add_images_response_get_type(), nullptr));
  self->value = fl_value_new_list();
  fl_value_append_take(self->value, fl_value_new_null());
  return self;
}

static MaplibreMapLibreHostApiAddImagesResponse* maplibre_map_libre_host_api_add_images_response_new_error(const gchar* code, const gchar* message, FlValue* details) {
  MaplibreMapLibreHostApiAddImagesResponse* self = MAPLIBRE_MAP_LIBRE_HOST_API_ADD_IMAGES_RESPONSE(g_object_new(maplibre_map_libre_host_api_add_images_response_get_type(), nullptr));
  self->value = fl_value_new_list();
  fl_value_append_take(self->value, fl_value_new_string(code));
  fl_value_append_take(self->value, fl_value_new_string(message != nullptr ? message : ""));
...
static void maplibre_map_libre_host_api_add_fill_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  ...
  self->vtable->add_fill_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_circle_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_circle_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_background_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  FlValue* value4 = fl_value_get_list_value(message_, 4);
  const gchar* above_layer_id = fl_value_get_string(value4);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_background_layer(id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_fill_extrusion_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_fill_extrusion_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_heatmap_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_heatmap_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_hillshade_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_hillshade_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_line_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_line_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_raster_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_raster_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_symbol_layer_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  ...
  const gchar* above_layer_id = fl_value_get_string(value5);
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_symbol_layer(id, source_id, layout, paint, below_layer_id, above_layer_id, handle, self->user_data);
}
...
static void maplibre_map_libre_host_api_add_images_cb(FlBasicMessageChannel* channel, FlValue* message_, FlBasicMessageChannelResponseHandle* response_handle, gpointer user_data) {
  MaplibreMapLibreHostApi* self = MAPLIBRE_MAP_LIBRE_HOST_API(user_data);
  ...
  FlValue* value0 = fl_value_get_list_value(message_, 0);
  FlValue* images = value0;
  g_autoptr(MaplibreMapLibreHostApiResponseHandle) handle = maplibre_map_libre_host_api_response_handle_new(channel, response_handle);
  self->vtable->add_images(images, handle, self->user_data);
}
...
void maplibre_map_libre_host_api_set_method_handlers(FlBinaryMessenger* messenger, const gchar* suffix, const MaplibreMapLibreHostApiVTable* vtable, gpointer user_data, GDestroyNotify user_data_free_func) {
  ...
  g_autofree gchar* add_images_channel_name = g_strdup_printf("dev.flutter.pigeon.maplibre.MapLibreHostApi.addImages%s", dot_suffix);
  ...
  fl_basic_message_channel_set_message_handler(add_images_channel, maplibre_map_libre_host_api_add_images_cb, g_object_ref(api_data), g_object_unref);
}
...
void maplibre_map_libre_host_api_respond_add_images(MaplibreMapLibreHostApiResponseHandle* response_handle) {
  g_autoptr(MaplibreMapLibreHostApiAddImagesResponse) response = maplibre_map_libre_host_api_add_images_response_new();
  g_autoptr(GError) error = nullptr;
  if (!fl_basic_message_channel_respond(response_handle->channel, response_handle->response_handle, response->value, &error)) {
...
void maplibre_map_libre_host_api_respond_error_add_images(MaplibreMapLibreHostApiResponseHandle* response_handle, const gchar* code, const gchar* message, FlValue* details) {
  g_autoptr(MaplibreMapLibreHostApiAddImagesResponse) response = maplibre_map_libre_host_api_add_images_response_new_error(code, message, details);
  g_autoptr(GError) error = nullptr;
  if (!fl_basic_message_channel_respond(response_handle->channel, response_handle->response_handle, response->value, &error)) {
    g_warning("Failed to send response to %s.%s: %s", "MapLibreHostApi", "addImages", error->message);
  }
...
void maplibre_map_libre_flutter_api_on_click(MaplibreMapLibreFlutterApi* self, MaplibreLngLat* point, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) {
  g_autoptr(FlValue) args = fl_value_new_list();
  fl_value_append_take(args, fl_value_new_custom_object(maplibre_lng_lat_type_id, G_OBJECT(point)));
...
void maplibre_map_libre_flutter_api_on_move_camera(MaplibreMapLibreFlutterApi* self, MaplibreMapCamera* camera, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) {
  g_autoptr(FlValue) args = fl_value_new_list();
  fl_value_append_take(args, fl_value_new_custom_object(maplibre_map_camera_type_id, G_OBJECT(camera)));
...
void maplibre_map_libre_flutter_api_on_start_move_camera(MaplibreMapLibreFlutterApi* self, MaplibreCameraChangeReason reason, GCancellable* cancellable, GAsyncReadyCallback callback, gpointer user_data) {
  g_autoptr(FlValue) args = fl_value_new_list();
  fl_value_append_take(args, fl_value_new_custom(maplibre_camera_change_reason_type_id, fl_value_new_int(reason), (GDestroyNotify)fl_value_unref));
