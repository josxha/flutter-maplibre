...
struct _MaplibreMapOptions {
  ...
  gboolean translucent_texture_surface;
  int64_t foreground_load_color;
};
...
MaplibreMapOptions* maplibre_map_options_new(const gchar* style, double zoom, double pitch, double bearing, MaplibreLngLat* center, MaplibreLngLatBounds* max_bounds, double min_zoom, double max_zoom, double min_pitch, double max_pitch, MaplibreMapGestures* gestures, gboolean android_texture_mode, gboolean translucent_texture_surface, int64_t foreground_load_color) {
  ...
  self->translucent_texture_surface = translucent_texture_surface;
  self->foreground_load_color = foreground_load_color;
  return self;
}
...
gboolean maplibre_map_options_get_translucent_texture_surface(MaplibreMapOptions* self) {
  g_return_val_if_fail(MAPLIBRE_IS_MAP_OPTIONS(self), FALSE);
  return self->translucent_texture_surface;
}

int64_t maplibre_map_options_get_foreground_load_color(MaplibreMapOptions* self) {
  g_return_val_if_fail(MAPLIBRE_IS_MAP_OPTIONS(self), 0);
  return self->foreground_load_color;
}
...
static FlValue* maplibre_map_options_to_list(MaplibreMapOptions* self) {
  ...
  fl_value_append_take(values, fl_value_new_bool(self->translucent_texture_surface));
  fl_value_append_take(values, fl_value_new_int(self->foreground_load_color));
  return values;
}
...
static MaplibreMapOptions* maplibre_map_options_new_from_list(FlValue* values) {
  ...
  gboolean translucent_texture_surface = fl_value_get_bool(value12);
  FlValue* value13 = fl_value_get_list_value(values, 13);
  int64_t foreground_load_color = fl_value_get_int(value13);
  return maplibre_map_options_new(style, zoom, pitch, bearing, center, max_bounds, min_zoom, max_zoom, min_pitch, max_pitch, gestures, android_texture_mode, translucent_texture_surface, foreground_load_color);
}
